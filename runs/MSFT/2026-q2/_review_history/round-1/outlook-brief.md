# Outlook Brief: MSFT — 2026-q2 (31 December 2025)
...
The near-term outlook is for continued double-digit growth, but with capacity allocation and artificial-intelligence infrastructure costs constraining how quickly demand converts into Azure revenue and cloud margin. Management guided to third-quarter revenue of \$80.65 billion to \$81.75 billion, Azure constant-currency growth of 37% to 38%, and Microsoft Cloud gross margin of roughly 65% [claim-016][claim-018][claim-020].
...
The conversion of demand into revenue depends on capacity allocation. Management said capital is serving first-party Copilots, research and development, and Azure rather than Azure alone [claim-023]. It also said many purchased graphics-processing units were already contracted for most of their useful lives, reducing some utilisation risk [claim-024].
...
Margins remain mixed. Fiscal-year operating margin improves slightly, but Microsoft Cloud gross margin declines as infrastructure investment and artificial-intelligence usage absorb part of the benefit from efficiency gains [claim-003][claim-018][claim-022].
...
Further upside would require Copilot adoption and usage to continue converting into paid seats and revenue while contracted infrastructure improves utilisation over its useful life [claim-014][claim-015][claim-024]. Observable confirmation would include Azure growth above the guided range, sustained Copilot seat growth, and cloud margin performing better than the roughly 65% guide [claim-018][claim-020].
...
Management's statement that Azure growth would have exceeded 40% under a different capacity allocation is counterfactual. It indicates allocation pressure but does not establish achievable future Azure growth [claim-023]. The duration and economics of individual customer contracts are also not disclosed in sufficient detail to independently quantify return on infrastructure investment [claim-024].
